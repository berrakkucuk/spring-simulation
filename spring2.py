...
tt = label(pos=vector(2,15,0),text='white ball',height=20,color=color.blue,linecolor=color.red)


for i in range(1,N+2):

    if(i==1):
        balls.append(sphere(pos=vector(i * 3 , 25, 0), radius=1, color=color.red))
    elif(i==N):
